...
import { SecondaryColorButton, LowEmphasisOnColoredBGButton } from "../../component-library/GenericComponents";
...
export default function LessonEndPage({ lessonIsReview }) {
    ...
    return (
        <Box className='lesson-end-page' sx={{backgroundColor: theme.palette.primary.dark}}>
            <Box className='lesson-end-body'>
                ...
                <Box className='lesson-end-button-box'>
                    ...
                    {!lessonIsReview && <SecondaryColorButton onClick={() => advanceLesson(true)} text='Következő lecke' />}
                    
                    <LowEmphasisOnColoredBGButton onClick={() => advanceLesson(false)} text='Kilépés a leckeválasztóba' />
                </Box>
            </Box>
        </Box>
        );
