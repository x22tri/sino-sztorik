    ...
    >
      {textContent && (
        <Button
          ...
          sx={{
            textTransform: 'none',
            color: color || theme.palette.primary.topbarButton,
            '&:hover': {
        ...
        >
          <Typography
            ...
            fontSize={14}
            noWrap
            sx={{ display: hideTextWhenSmall && { xs: 'none', md: 'block' } }}
          >
            {textContent}
          </Typography>
        </Button>
...
const ThemeChangeButton = ({ themeToggle, ...props }) => {
  ...
  return (
    <TopbarButton
      ...
      endIcon={
        <FontAwesomeIcon
          icon={theme.palette.type === 'dark' ? faSun : faMoon}
        />
      }
    />
  )
  ...
  return (
    <>
      <AppBar
        ...
        color='transparent'
        style={{
          borderBottom: borderBottom || `2px solid ${theme.palette.divider}`,
        }}
      >
        <Toolbar
          variant='dense'
          ...
          sx={{
            padding: '0 10px',
            backgroundColor: color || theme.palette.primary.topbarBackground,
          }}
        >
          {children}
        </Toolbar>
