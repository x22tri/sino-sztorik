...
export const FREQUENCY_UNKNOWN = 'Nem elérhető'
export const FREQUENCY_VERY_COMMON = 'Nagyon gyakori'
export const FREQUENCY_QUITE_COMMON = 'Elég gyakori'
export const FREQUENCY_COMMON = 'Gyakori'
...
export const ERROR_AIYA = [
  { glyph: '哎', pinyin: 'Āi', keyword: 'Hajjaj!' },
  { glyph: '呀', pinyin: 'ya', keyword: 'azta!' },
  { glyph: '！' },
]
...
export const ADMIN_BACK_FROM_SUBMENU_SHORT = 'Vissza'
...
export const ADMIN_EDIT_STEPS_STEP_ONE = 'Adatok megadása'
export const ADMIN_EDIT_STEPS_STEP_TWO = 'Idővonal'
export const ADMIN_EDIT_STEPS_STEP_THREE = 'Ellenőrzés'
